...
load(file = "../processed_data/modeles.RData")
...
```{r}
tableau_peches %>% 
  DT::datatable(colnames = c("Station", "Année", "Cran", "Conductivité", "Conductivité à 25°C", "Température", "Voltage", "Puissance", "Intensité", "Penny à 1m du centre", "Penny à 1,5m du centre", "Penny à 1,5m du bord"), rownames = FALSE)
```
...
```{r}
graph_histo(x = "penny_1m_c", data = data, xlab = "Mesure Penny à 1m du centre", type = "pêches")
graph_histo(x = "intensite", data = data, xlab = "Intensité", type = "pêches")
graph_histo(x = "voltage", data = data, xlab = "Voltage", type = "pêches")
graph_histo(x = "penny_1.5m_c", data = data, xlab = "Mesure Penny à 1,5m du centre", type = "pêches")
...
graph_var_qual_var_quant(data = data,
                   var_quant = "penny_1m_c", var_quant_label = "Mesure Penny à 1m du centre",
                   var_qual = "cran", var_qual_label = "Cran de réglage du Héron")

graph_var_qual_var_quant(data = data,
                   var_quant = "penny_1.5m_c", var_quant_label = "Mesure Penny à 1,5m du centre",
                   var_qual = "cran", var_qual_label = "Cran de réglage du Héron")
...
```{r}
quantile_penny(data = data, penny = "penny_1m_c", penny_lab = "Mesure Penny à 1m du centre (V)")
```
...
```{r}
quantile_penny(data = data, penny = "penny_1.5m_c", penny_lab = "Mesure Penny à 1,5m du centre (V)")
```
