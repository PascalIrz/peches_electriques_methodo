...
EPA Bateau
```{r, fig.height = 8}
g_cor(cor_epa_bateau)
```
Le schéma lors des prospections en bateau est assez différent du schéma général. Il y a peu de relations significatives, ce qui peut être lié au faible nombre des observations. La mesure Penny n'est corrélée à aucune autre variable.
